...
/* package to-0.1.0.0 */
#define VERSION_to "0.1.0.0"
#define MIN_VERSION_to(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "to-0.1.0.0-s6lWm4OQzQLMVSltGlBs3"

#define CURRENT_PACKAGE_KEY "to-0.1.0.0-s6lWm4OQzQLMVSltGlBs3"
